...
class HTTPRequestTool:
    def __init__(self, root):
        ...
        self.header_info = {
            ...
            "Sec-Browsing-Topics": "Sends the selected topics for the current user along with the associated request, used by ad tech platforms to choose personalized ads",
