   ...
   <body>
    ...
    def analyze_static_file(self):
        ...
        sensitive_patterns = {
            ...
            "Phone Numbers": [
                # US/Canada format with area code validation
                r'\b(?:\+?1[-. ]?)?(?:\(?([2-9][0-8][0-9])\)?[-. ]?([2-9][0-9]{2})[-. ]?([0-9]{4}))\b',
                # International format with country code validation
                r'\b(?:\+?([1-9][0-9]{0,2})[-. ]?)?(?:\(?([2-9][0-9]{1,2})\)?[-. ]?([0-9]{3,4})[-. ]?([0-9]{4}))\b',
                # Common business phone format
                r'\b(?:tel|phone|telephone)[: ]+[\+]?[0-9]{1,3}[-. ]?\(?[0-9]{2,3}\)?[-. ]?[0-9]{3,4}[-. ]?[0-9]{4}\b',
                # HTML format with validation
                r'(?:Phone|phone|Tel|tel|Telephone|telephone)[: ]+[\+]?[0-9]{1,3}[-. ]?\(?[0-9]{2,3}\)?[-. ]?[0-9]{3,4}[-. ]?[0-9]{4}',
                # UK format (e.g., +44 20 7946 0958)
                r'\b(?:\+?44[-. ]?)?(?:\(?0\)?[-. ]?)?([1-9][0-9]{1,3})[-. ]?([0-9]{3,4})[-. ]?([0-9]{4})\b',
                # Australian format (e.g., +61 2 9876 5432)
                r'\b(?:\+?61[-. ]?)?(?:\(?0\)?[-. ]?)?([2-8][0-9])[-. ]?([0-9]{4})[-. ]?([0-9]{4})\b',
                # Japanese format (e.g., +81 3-1234-5678)
                r'\b(?:\+?81[-. ]?)?(?:\(?0\)?[-. ]?)?([1-9][0-9])[-. ]?([0-9]{4})[-. ]?([0-9]{4})\b',
                # German format (e.g., +49 30 1234567)
                r'\b(?:\+?49[-. ]?)?(?:\(?0\)?[-. ]?)?([1-9][0-9]{1,3})[-. ]?([0-9]{3,7})\b',
                # French format (e.g., +33 1 23 45 67 89)
                r'\b(?:\+?33[-. ]?)?(?:\(?0\)?[-. ]?)?([1-9][0-9])[-. ]?([0-9]{2})[-. ]?([0-9]{2})[-. ]?([0-9]{2})[-. ]?([0-9]{2})\b',
                # Indian format (e.g., +91 98765 43210)
                r'\b(?:\+?91[-. ]?)?(?:\(?0\)?[-. ]?)?([6-9][0-9]{4})[-. ]?([0-9]{5})\b'
            ],
            "Credit Card Numbers": [
